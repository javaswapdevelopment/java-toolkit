...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c3:hover:not(:disabled):not(.java-button--disabled):not(.java-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c3:active:not(:disabled):not(.java-button--disabled):not(.java-button--disabled) {
      opacity: 0.85;
    ...
    .c37:hover:not(:disabled):not(.java-button--disabled):not(.java-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c37:active:not(:disabled):not(.java-button--disabled):not(.java-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
    ...
    .c44:hover:not(:disabled):not(.java-button--disabled):not(.java-button--disabled):not(:active) {
      opacity: 0.65;
    }

    .c44:active:not(:disabled):not(.java-button--disabled):not(.java-button--disabled) {
      opacity: 0.85;
      -webkit-transform: translateY(1px);
      -ms-transform: translateY(1px);
      transform: translateY(1px);
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    <a
                      href="https://javaswap.io/accounts"
                      role="button"
                    >
                      <div
                        class="c13"
                ...
                >
                  ...
                  >
                    <circle
                      cx="45"
                      cy="45"
                      fill="url(#paint0_linear_javaround)"
                      r="45"
                    />
                    <path
                      clip-rule="evenodd"
                    ...
                    <path
                      ...
                      fill="url(#paint1_linear_javaround)"
                      fill-rule="evenodd"
                    />
                    <path
                      clip-rule="evenodd"
