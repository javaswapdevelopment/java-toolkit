...
import chaoticJavarsSm from "./teams/chaotic-javars-sm.png";
import chaoticJavarsMd from "./teams/chaotic-javars-md.png";
import chaoticJavarsLg from "./teams/chaotic-javars-lg.png";
import chaoticJavarsAlt from "./teams/chaotic-javars-alt.png";
import chaoticJavarsBg from "./teams/chaotic-javars-bg.svg";
...
const teamImages: ImageMap = {
  ...
  "chaotic-javars-sm.png": chaoticJavarsSm,
  "chaotic-javars-md.png": chaoticJavarsMd,
  "chaotic-javars-lg.png": chaoticJavarsLg,
  "chaotic-javars-alt.png": chaoticJavarsAlt,
  "chaotic-javars-bg.svg": chaoticJavarsBg,
};
