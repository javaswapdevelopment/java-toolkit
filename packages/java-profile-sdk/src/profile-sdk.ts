...
class JavaProfileSdk {
   ...
   * API repo - https://github.com/javaswapdevelopment/java-profile-api
   */
   ...
   * Contract repo - https://github.com/javaswapdevelopment/java-contracts/tree/master/projects/profile-nft-gamification
   */
   ...
   * from JavaProfile contract.
   * NFT's bunnyId is retrieved from JavaBunnies contract and mapped to static NFT data stored in constant.
   * Contracts repo - https://github.com/javaswapdevelopment/java-contracts/tree/master/projects/profile-nft-gamification
   */
  getProfile = async (address: string): Promise<GetProfileResponse> => {
    try {
      ...
      if (isActive) {
        ...
        const avatar = nft ? `https://javaswap.io/images/nfts/${nft.images.sm}` : undefined;
        ...
        Cookies.set(
          ...
          { domain: "javaswap.io", secure: true, expires: 30 }
        );
      }
